...
MzTreeView.prototype.nodeToHTML = function(node, AtEnd)
{
  ...
  HTML += "<IMG "+
    ...
    "</A></li>" +
    "<li id=\"list_1\"><a href=\"#\">共10823道题</a></li><li id=\"list_2\"><a href=\"#\">已答250道</a></li><li id=\"list_3\">" +
    "<a href=\"#\">答错50道</a></li><li id=\"list_4\">正确率:<i><span style=\"width:100px;height:10px;display:inline-block;background-color:#cccccc\"/>"+
    "<span style=\"width:80px;height:10px;display:inline-block;background-color:#3399ff\"/>"+
    "</i>80%</li><li id=\"list_5\"><a href=\"WebFrame/Practice.dsr?cid="+node.sourceIndex.split("_")[1]+"\">开始做题</a></li><li id=\"list_6\"><a href=\"#\">教程</a></li></ul>"+
    "</NOBR></DIV>";
...
MzTreeView.prototype.expand   = function(id, sureExpand)
{
  ...
  if (area)
  {
  	  // Dowｎｌｏａｄｓ　Ｂｙ　ｈｔｔｐ：／／ｄｏｗn.lｉｅｈｕo．nｅｔ
